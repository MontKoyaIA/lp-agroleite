# Landing Page · Agroleite 2026 × Mont Kóya
...
Os preços saem 1 dia antes do evento. Abra o HTML e edite o bloco `PRICES` dentro de `<script id="config">` (instruções comentadas no topo do arquivo). O número do WhatsApp do formulário está na constante `WHATSAPP`, no mesmo bloco.
